...
pubDate: '2014-05-03'
categories: ['hosting']
description: 'Setting up nested password-protected WebDAV directories on Dreamhost required only a small .htaccess tweak to coexist with WordPress, after which a hierarchy of directories with per-user access was configured successfully through the Dreamhost panel.'
---
